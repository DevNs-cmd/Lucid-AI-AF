    ...
    <div className="relative min-h-screen w-full flex items-center justify-center font-body text-ink overflow-hidden bg-background">
      ...
      >
        ...
        <div className="text-center mb-8">
          <h1 className="font-display font-bold text-3xl tracking-wide mb-2">Create Account</h1>
          <p className="text-muted font-light">Your infinite journey begins here.</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); window.location.href = '/dashboard'; }}>
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted">Adventurer Name</label>
        ...
        <p className="text-center text-sm text-muted mt-8">
          Already have an account? <Link href="/login" className="text-glow-primary hover:underline">Log in</Link>
        </p>
      </motion.div>
    </div>
  );
