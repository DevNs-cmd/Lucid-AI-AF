...
exports.converseWithNPC = converseWithNPC;
const client_1 = require("@prisma/client");
const gemini_1 = require("../config/gemini");
const genai_1 = require("@google/genai");
const prisma = new client_1.PrismaClient();
const npcChatResponseSchema = {
 ...
 */
async function converseWithNPC(req, res) {
    try {
        ...
        const historyLogs = (dialogueHistory || []);
    ...
    `;
        ...
        const modelResponse = await gemini_1.aiClient.models.generateContent({
